 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://www.example.org/mywsdl/", wsdlLocation = "file:/D:/sid/workspace_webservice/06_wsdl/src/META-INF/wsdl/mywsdl.wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICEIMPLSERVICE_QNAME = new QName("http://www.example.org/mywsdl/", "MyServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/D:/sid/workspace_webservice/06_wsdl/src/META-INF/wsdl/mywsdl.wsdl");
    ...
    public IMyService getMyServiceImplPort() {
        return super.getPort(new QName("http://www.example.org/mywsdl/", "MyServiceImplPort"), IMyService.class);
    }
    ...
    public IMyService getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.example.org/mywsdl/", "MyServiceImplPort"), IMyService.class, features);
    }
