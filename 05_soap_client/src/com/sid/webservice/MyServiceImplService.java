 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://www.sid.com/webservice", wsdlLocation = "http://localhost:8989/ms?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICEIMPLSERVICE_QNAME = new QName("http://www.sid.com/webservice", "MyServiceImplService");
    ...
    public IMyService getMyServiceImplPort() {
        return super.getPort(new QName("http://www.sid.com/webservice", "MyServiceImplPort"), IMyService.class);
    }
    ...
    public IMyService getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.sid.com/webservice", "MyServiceImplPort"), IMyService.class, features);
    }
