 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://service.zttc.edu.cn", wsdlLocation = "http://localhost:8080/web-soa/us?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/web-soa/us?wsdl");
