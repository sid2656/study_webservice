 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://service.zttc.edu.cn", wsdlLocation = "file:/D:/sid/workspace_webservice/web-soa/src/main/webapp/WEB-INF/wsdl/user.wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://service.zttc.edu.cn", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/D:/sid/workspace_webservice/web-soa/src/main/webapp/WEB-INF/wsdl/user.wsdl");
    ...
    public IUserService getUserServicePort() {
        return super.getPort(new QName("http://service.zttc.edu.cn", "userServicePort"), IUserService.class);
    }
    ...
    public IUserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.zttc.edu.cn", "userServicePort"), IUserService.class, features);
    }
