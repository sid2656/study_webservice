 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://service.sid.org/", wsdlLocation = "http://localhost:6666/ns?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICEIMPLSERVICE_QNAME = new QName("http://service.sid.org/", "MyServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:6666/ns?wsdl");
    ...
    public IMyService getMyServiceImplPort() {
        return super.getPort(new QName("http://service.sid.org/", "MyServiceImplPort"), IMyService.class);
    }
    ...
    public IMyService getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.sid.org/", "MyServiceImplPort"), IMyService.class, features);
    }
