 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://service.zttc.edu.cn", wsdlLocation = "http://localhost:9898/us?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9898/us?wsdl");
